package com.github.wongxd.core_lib.data.net

import android.content.Context
import android.content.Intent
import com.github.wongxd.core_lib.base.utils.utilcode.util.DeviceUtils
import com.github.wongxd.core_lib.base.utils.utilcode.util.SPUtils
...
class WNet {
    ...
    companion object {
        ...
        fun checkVersion(pkgVersionName: String, intentAction: String, ctx: Context) {
            doAsync {
