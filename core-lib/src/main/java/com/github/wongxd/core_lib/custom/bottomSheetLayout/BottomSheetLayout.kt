package com.github.wongxd.core_lib.custom.bottomSheetLayout
...
class BottomSheetLayout : FrameLayout {
    ...
    private fun childTouch(eventX: Float, eventY: Float): Boolean {
    ...
    private inner class TouchToDragListener(val touchToDrag: Boolean) : View.OnTouchListener {
            ...
            when (action) {
                MotionEvent.ACTION_DOWN -> {
                    if (ev.pointerCount == 1) {
                        ...
                        return childTouch(startX, startY)
                    }
                }
        ...
        fun isAClick(startX: Float, endX: Float, startY: Float, endY: Float, endTime: Long): Boolean {
